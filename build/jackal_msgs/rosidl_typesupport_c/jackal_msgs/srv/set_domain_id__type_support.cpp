...
static const _SetDomainId_Request_type_support_symbol_names_t _SetDomainId_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jackal_msgs, srv, SetDomainId_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, jackal_msgs, srv, SetDomainId_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, jackal_msgs, srv, SetDomainId_Request)() {
  return &::jackal_msgs::srv::rosidl_typesupport_c::SetDomainId_Request_message_type_support_handle;
}
...
static const _SetDomainId_Response_type_support_symbol_names_t _SetDomainId_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jackal_msgs, srv, SetDomainId_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, jackal_msgs, srv, SetDomainId_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_jackal_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, jackal_msgs, srv, SetDomainId_Response)() {
  return &::jackal_msgs::srv::rosidl_typesupport_c::SetDomainId_Response_message_type_support_handle;
}
...
static const _SetDomainId_type_support_symbol_names_t _SetDomainId_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jackal_msgs, srv, SetDomainId)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, jackal_msgs, srv, SetDomainId)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, jackal_msgs, srv, SetDomainId)() {
  return &::jackal_msgs::srv::rosidl_typesupport_c::SetDomainId_service_type_support_handle;
}
