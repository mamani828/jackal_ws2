...
bool jackal_msgs__msg__drive_feedback__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * jackal_msgs__msg__drive_feedback__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool jackal_msgs__msg__feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("jackal_msgs.msg._feedback.Feedback", full_classname_dest, 34) == 0);
  }
  jackal_msgs__msg__Feedback * ros_message = _ros_message;
  {  // header
  ...
  {  // drivers
    ...
    Py_ssize_t size = 2;
    jackal_msgs__msg__DriveFeedback * dest = ros_message->drivers;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!jackal_msgs__msg__drive_feedback__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * jackal_msgs__msg__feedback__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("jackal_msgs.msg._feedback");
  ...
  {  // drivers
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = jackal_msgs__msg__drive_feedback__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
